...
写真のことだけ、少し書いておきます。以前の版はGoogleドライブに置いていましたが、今はどこにも送りません。その代わり、選んだ瞬間に端末の中で長辺八百ピクセルまで縮めます。教室でふつうに撮った写真なら、六十キロバイトから百キロバイトほどになります。縮めるのはブラウザの中だけで完結する処理なので、外に出ていく通信は起きません。
...
いちばん下には、その端末にどれだけたまっているかが出ます。八割を超えると赤くなります。写真つきの記事は一本で百キロバイトほど使うので、四十本くらいが目安です。これを黙って超えると「送ったのに保存されていない」が起きるので、先に見えるようにしてあります。
